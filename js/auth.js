...
async function login() {
  ...
  if (!email || !password) return showError("يرجى إدخال البريد الإلكتروني وكلمة المرور");
...
auth.onAuthStateChanged((user) => {
  ...
  if (user) {
    ...
    document.getElementById("userName").textContent = user.displayName || "مسؤول النظام";
